...
Verify that the NocoBase instance is reachable, the API key is valid, and read access works before attempting any other operations.
...
2. **API key is generated** -- create one in the NocoBase admin panel under Settings > API keys.
3. **Environment variables are set** in the user's project or shell.
