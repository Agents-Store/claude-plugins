...
## Example 6: Self-Hosted Health Check
...
Tool: tds-get_current_worker
Input: {"environment": "prod"}
→ {version: "20250301.1", tasks: [...]}

# 3. Check recent run health
Tool: tds-list_runs
Input: {"environment": "prod", "period": "1h", "limit": 10}
→ [list of recent runs with statuses]

# 4. Check for failures
Tool: tds-list_runs
Input: {"environment": "prod", "status": "FAILED", "period": "1d"}
→ [] (empty = no failures)
```
